...
# 2. 실행중인 작업 취소, 완료 여부 체크, 타입아웃 옵션, 콜백추가, 동기화 코드 매우 쉽게 작성 -> Promise 개념
...
def main():
    ...
    with ThreadPoolExecutor() as excutor:
        ...
        # # 성공
        # print("Completed Tasks : {}".format(str(result.done)))
        # # 실패
        # print(
        #     "Pending ones after waiting for 5seconds : {}".format(str(result.not_done))
        # )
        ...
        for future in as_completed(futures_list):
            ...
            print("Future Calcelled : {}, Done : {}".format(result, cancelled))
    # 종료 시간
